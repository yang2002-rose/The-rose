...
<el-drawer
 ...
 <a>销售线索</a>
  ...
  <el-tabs v-model="activeName" @tab-click="handleClick" class="cxs1-1-1">
    <el-tab-pane label="全部线索" name="first">
        <!-- 搜索 -->
      <div>
         <el-input v-model="input" class="inputs1" placeholder="搜索关键词"></el-input>
         &nbsp;
    <el-select v-model="value" class="inputs1" placeholder="线索来源">
    <el-option
  ...
  &nbsp;
  <el-select v-model="value" class="inputs1" placeholder="线索状态">
    <el-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
  ...
  &nbsp;
  <el-select v-model="value" class="inputs1" placeholder="归属人员">
    <el-option
      v-for="item in options"
      :key="item.value"
      :label="item.label"
  ...
  :total="100">
      ...
      <el-tab-pane label="我的线索" name="two" disabled="">

      </el-tab-pane>
      <el-tab-pane label="下属的线索" name="two" disabled="">

      </el-tab-pane>
      <el-tab-pane label="已转客户" name="two" disabled="">
