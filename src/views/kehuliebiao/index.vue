   ...
   <el-date-picker
    ...
    <el-button type="primary" class="buts1" icon="el-icon-search">查询</el-button>
     ...
     <el-button type="primary" icon="el-icon-plus">添加</el-button>
      <el-button icon="el-icon-download" class="inputs11">导入</el-button>
      <el-button icon="el-icon-upload2" class="inputs11">导出</el-button>
     <el-button icon="el-icon-s-fold" class="inputs11">新建任务</el-button>
     <el-button icon="el-icon-refresh" class="inputs11">转移客户</el-button>
     <el-button icon="el-icon-share" class="inputs11">合并客户</el-button>
     <el-button icon="el-icon-edit" class="inputs11">批量编辑</el-button>
     &nbsp;
